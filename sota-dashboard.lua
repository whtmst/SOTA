...
function SOTA_PlaceholderButton()
    local jokes = {
        "ЭТА КНОПКА НИЧЕГО НЕ ДЕЛАЕТ... КАК И ТВОЯ ЖИЗНЬ",
        "ТЫК! Кнопка сказала 'спасибо' и ушла в запой",
        "ОШИБКА 404: ФУНКЦИЯ НЕ НАЙДЕНА (как и смысл бытия)",
        "Поздравляю! Вы нажали самую бесполезную кнопку в игре",
        "ЭТА КНОПКА - КАК ТВОЙ БЫВШИЙ: МНОГО ОБЕЩАНИЙ, НОЛЬ РЕЗУЛЬТАТА",
        "СЕКРЕТНАЯ КНОПКА! (шучу, она пустая)",
        "ТЫ НАЖАЛ НА КНОПКУ! ...И ничего не произошло. Как и в твоей жизни.",
        "ВНИМАНИЕ! Эта кнопка украдена гоблинами из Чёрной Горы, найдешь их скажи чтобы вернули.",
        "ЭТА КНОПКА ДОЛЖНА БЫЛА БЫТЬ КРУТОЙ... но лень меня победила",
        "ПОЗДРАВЛЯЮ! Вы выиграли... абсолютно ничего!"
    }
